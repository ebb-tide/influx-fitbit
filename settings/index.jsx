// The declaration for application settings. 
// Make an app configurable by the user. 
// Code within this file has access to the Settings API.
...
function mySettings(props) {
  return (
    <Page>
      <Section
        title={<Text bold align="center">InfluxDB App</Text>}>
        <AdditiveList
